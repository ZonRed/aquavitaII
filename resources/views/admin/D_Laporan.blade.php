    ...
    <table class="table table-bordered" style="margin-left: 220px; padding: 20px;">
        ...
        <div class="container-fluid content-area">
            <div class="row mb-3">
                 ...
                 <div class="col-md-12">
                    ...
                    <p class="text-danger">ketika ingin mencari email harap tekan tombol "cari"</p> 
                    <p class="text-danger">begitu juga ketika refresh tekan tombol "cari"!</p>
                </div>
                <div class="col-md-3">
                    <div class="input-group">
                         <!-- fitur pencarian -->
                        <form action="{{ url('/D_Laporan') }}" method="GET" id="searchForm">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Search Email.." id="searchInput" name="caripengguna_email">
        ...
        <tbody id="myTable">
            ...
            <tr>
                ...
                <td>{{$l->email_laporan}}</td>
                <td>{{$l->pesan_laporan}}</td>
                <td>
