    ...
    <table class="table table-bordered" style="margin-left: 220px; padding: 20px;">
                    ...
                    <div class="input-group">
                        ...
                        <form action="{{ url('/D_Jadwal') }}" method="GET" id="searchForm">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Search Hari.." id="searchInput" name="carihariadmin_jadwal">
        ...
        <tbody id="myTable">
            ...
            <tr>
                ...
                <a href="{{ url('/delete_Jadwal/' . $ja->id) }}" class="btn btn-danger">Delete</a>
                </td>
            </tr>
            @endforeach
        </tbody>
