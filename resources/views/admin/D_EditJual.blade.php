...
<head>
    ...
    <title>Admin Dashboard - Edit Isi Penjualan</title>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .content-area {
                margin-left: 0;
                padding-left: 15px;
                /* Berikan padding kiri untuk konten pada layar kecil */
            }
        }
        ...
        .fixed-top-right {
            ...
            /* Tambahkan background color untuk tetap terlihat */
            padding: 5px 10px;
            /* Berikan padding agar tidak terlalu kecil */
            border-radius: 5px;
            /* Tambahkan border radius untuk tampilan yang lebih baik */
        }
        ...
        @media (max-width: 768px) {
            .fixed-top-right {
                ...
                text-align: center;
                margin-bottom: 10px;
                /* Tambahkan margin bottom agar tidak menumpuk */
            }
        }
    </style>
</head>
...
<body>
    ...
    <section id="edit-jual" class="py-5">
        <div class="container-fluid content-area">
            <h2>Admin Dashboard - Edit Isi Penjualan</h2>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('/update_Jual/' . $Jual->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="code_jual" class="form-label">Code Barang <span class="text-danger">(tidak boleh
                                    sama "code barang" dengan
                                    lainnya!)</span>
                                <span class="text-danger">*</span>
                            </label>
                        ...
                        <!-- Input untuk type -->
                        <div class="mb-3">
                            <label for="type_jual" class="form-label">Type Barang <span class="text-danger">(tidak boleh
                                    sama "type barang" dengan
                                    lainnya!)</span>
                                <span class="text-danger">*</span>
                            </label>
                        ...
                        <div class="mb-3">
                            <label for="jumlah_jual" class="form-label">Jumlah Stock <span class="text-danger">(jika
                                    tidak ada ,isi dengan angka
                                    "0")</span>
                                <span class="text-danger">*</span>
                            </label>
