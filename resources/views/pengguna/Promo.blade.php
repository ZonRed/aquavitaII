                                ...
                                <div class="card">
                                    ...
                                    <form action="{{ url('/Promo') }}" method="GET" id="searchForm">
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" placeholder="Search Code Promo.."
                                                id="searchInput" name="caricodepengguna_promo">
                            ...
                            <div class="d-flex justify-content-center mt-3">
                                <nav aria-label="Page navigation">
                                    <ul class="pagination pagination-sm">
                                        ...
                                        @else
                                            <li class="page-item">
                                                <a class="page-link" href="{{ $Promo->previousPageUrl() }}"
                                                    aria-label="Previous">
                                        ...
                                        @if ($Promo->hasMorePages())
                                            <li class="page-item">
                                                <a class="page-link" href="{{ $Promo->nextPageUrl() }}"
                                                    aria-label="Next">
        ...
        $(document).ready(function() {
            $("#searchInput").on("keyup", function() {
                ...
                $("#myTable tr").filter(function() {
                    ...
                    var code_promo = $(this).find('td:eq(1)').text()
                .toLowerCase(); // Menggunakan indeks kolom 1, karena indeks dimulai dari 0
