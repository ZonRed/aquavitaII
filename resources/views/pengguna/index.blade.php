...
<body>
    ...
    <section id="beranda" class="py-5" style="margin-top: 80px;">
        <div class="container text-center">
            <div class="col text-center">
                ...
                <p>"AQUAVITA II - tempat terpercaya untuk mendapatkan minuman berkualitas dan es batu yang segar sepanjang hari!" </p>
            </div>
        </div>
    </section>
    ...
    <section id="informasi-penjualan" class="bg-light py-5">
        <div class="container">
            ...
            <div class="row">
                 ...
                 <div class="col-md-4">
                    <div class="card mb-4">
                        <img src="{{ asset('image/jadwal_operasional.png') }}" style="max-width: 100%; height: auto; object-fit: cover;" class="card-img-top" alt="Berita 1">
                ...
                <div class="col-md-4">
                    <div class="card mb-4">
                        <img src="{{ asset('image/produk_penjualan.png') }}" style="max-width: 100%; height: auto; object-fit: cover;" class="card-img-top" alt="Berita 2">
                 ...
                 <div class="col-md-4">
                    <div class="card mb-4">
                        <img src="{{ asset('image/promo.png') }}" style="max-width: 100%; height: auto; object-fit: cover;" class="card-img-top" alt="Berita 3">
                        <div class="card-body">
                 ...
                 <div class="col-md-4">
                    <div class="card mb-4">
                        <img src="{{ asset('image/kontak.png') }}" style="max-width: 100%; height: auto; object-fit: cover;" class="card-img-top" alt="Berita 4">
                        <div class="card-body">
    ...
    <section id="lokasi-map" class="py-5">
        <div class="container">
            <div class="col text-center">
                ...
                <p>Tempat Lokasi "AQUAVITA II" , Untuk Petunjuk Lokasi Google Map bisa tekan tombol 'Buka di Google Maps' di bawah map</p>
            </div>
    ...
    <section id="keluh-kesah" class="py-5">
        <div class="container">
            <div class="col text-center">
                ...
                <p>Jika Anda memiliki pertanyaan atau masukan, jangan ragu untuk berkeluh kesah melalui formulir di bawah ini.</p>
            </div>
            ...
            <form action="{{ url('SaveLaporan') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="email_laporan" required>
                </div>

                <!-- Input untuk Kritikan -->
                <div class="mb-3">
                    <label for="pesan_laporan" class="form-label">Pesan</label>
   ...
   <!-- Replace the Google Maps API script with HERE Maps API script -->
    ...
    <script>
        ...
        const platform = new H.service.Platform({ apikey: "v0UpMK3EXITJJAAkMChM_mCOktil9_ddFSpiQRwnhGo" });
        const defaultLayers = platform.createDefaultLayers();
        const map = new H.Map(
            document.getElementById("map"),
            defaultLayers.vector.normal.map,
            {
                center: { lat: -7.3723192539977065, lng: 112.73006055952578 },
        ...
        function addMarkersToMap(map) {
            var fanbasemarker = new H.map.Marker({ lat: -7.3723192539977065, lng: 112.73006055952578 });
    ...
    function openGoogleMaps() {
        const fanbaseLocation = { lat: -7.3723192539977065, lng: 112.73006055952578 };
